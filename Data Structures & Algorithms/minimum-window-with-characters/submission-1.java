class Solution {
    ...
    public String minWindow(String s, String t) {
        ...
        while (right < s.length()) {
            ...
            // now, for inner while, we'll keep on checking if the number of characters of string t is there in string s
            while (contain(s1Array, s2Array)) {
                // now, if characters of string t exists in string s based on "contain" method, we keep on updating the minwindowlength
