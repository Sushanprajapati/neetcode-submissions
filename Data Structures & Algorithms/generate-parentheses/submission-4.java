class Solution {
    public List<String> generateParenthesis(int n) {
        ...
        // StringBuilder = Single Threaded/Not Thread safe/ Fast performance
        // StringBuffer = Multi Thread/ Thread safe/ Slow
    ...
    public void backTrack(int open, int closed, int n, StringBuilder tempString, List<String> result) {
